subprojects {
    group = "ru.anarchyghost.basketball.modules.profile"
}
...
dependencies {
    ...
    implementation(project(":modules:profile:application"))
    implementation(project(":modules:profile:infrastructure"))
